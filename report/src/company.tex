\subsubsection{Mahindra University: history and fundings}
...
\subsubsection{Research teams and projects}
...
us were in MU, but to keep contact with Amrit we made many videocalls. As Dr
Nidhi Goyal is Assistant Professor, she is also a lecturer and couldn't be full
time on the research project, she was also helping with clubs in the university.

Then, Gaspard and I helped to set up experiments about the attention of car
drivers,  subjects drove on a driving simulator and were subject to disturbances
(phone notification, dashboard warning light, storm), an eye tracker and a EEG
headset monitored their reactions. The project was established through a
collaboration between Mahindra University (MU) and the University of Hyderabad
(UoH), the team was composed of Dr Sunder Bukya (MU), Dr Nidhi Goyal (MU), Dr
Shiva Ram Reddy (UoH) and Srujan Kumar (B. Tech student from UoH).

\subsubsection{Differences with French universites}
...
permission to leave the campus. Construction workers, wardens, cleaning staff,
canteen cooks were many and had a special uniform showing their role.

Students had many clubs in the university, but those clubs quite often work
related, like a programming club, crafting club, research club, etc... Students
faced a high competition to be part of some clubs, they had to apply and go
...
students had a mantaory French language course. 

\subsubsection{Using a supercomputer (NVidia DGX-A100)}

The NVidia DGX-A100 Cluster.

A supercomputer had to be used to perform the experiments and it showed multiple
difficulties
\begin{itemize}
...
installed CUDA version, in order to have more recent CUDA versions it was needed
to use a NVidia CUDA container with the enroot command.

\item Availability of the cluster
Even though the cluster had two nodes, it could not handle too many tasks in the
same time, making it impossible to use the cluster half of the time. 
\end{itemize}

However, the supercomputer system admin, Aman Iftekhar, was always very
easy to reach, he helped a lot through the whole internship.