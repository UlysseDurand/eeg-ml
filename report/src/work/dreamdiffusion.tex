...
\begin{figure}[H]
    ...
    \input{src/work/dreamdiffusion.tikz}
...
\cite{Schirrmeister2017} datasets. In the process of reproducing what Racim did, I
corrected an error in a dataset with a GitHub pull request
...
other machine, those little issues were fixed and I proposed a pull request, but
...
I had to go through the whole code to begin with it. The code is taken from
\cite{mindvis} so and the structure of the files and their roles was new to me
so it also took a good amount of time to understand every bit.
...
We can distinguish two common mistakes that happen in the 70 left percents. The
